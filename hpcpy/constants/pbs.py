...
# Statuses
STATUSES = [
    Status("B", None, "Array job has at least one subjob running", generic=hc.STATUS_HAS_SUBJOB),
    ...
    Status("U", None, "Cycle-harvesting job is suspended due to keyboard activity", generic=hc.STATUS_CYCLE_HARVESTING),
    Status("W", None, "Job is waiting for its submitter-assigned start time to be reached", generic=hc.STATUS_WAITING),
    Status("X", None, "Subjob has completed execution or has been deleted", generic=hc.STATUS_SUBJOB_COMPLETED)
]